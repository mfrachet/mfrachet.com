...
The reason is that our backend only knows how to deal with regular HTML form. We need to improve it and make it able to deal with regular HTML form but also with JSON requests using `fetch`.
