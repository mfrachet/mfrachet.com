...
_This blog post has inspired the creation of [Flag Engine](https://github.com/mfrachet/flag-engine) which is a runtime and source agnostic feature flags evalutation tools._
